# Session Handoffs: Giving Your AI Assistant Memory That Actually Persists
...
*Who this is for: Anyone using AI coding assistants who's frustrated by re-explaining context every session. Works with Claude, GPT, Cursor, or whatever comes next.*

**Part 2 of the [Designing AI Teammates](https://dev.to/dorothyjb/how-we-built-a-documentation-system-that-makes-llms-productive-immediately-59hc) series.** Part 1 covered onboarding an AI assistant using durable documentation. This article covers the next step: making that knowledge persist across the inevitable session boundaries.
...
**ChatGPT's Memory** persists facts across conversations. "Remember that I prefer TypeScript" carries forward.
...
What happens when you switch from Claude to GPT? When you upgrade accounts? When a teammate needs to pick up where you left off?
...
Built-in AI memory can't do this. You can't grep ChatGPT's brain.
...
Using Claude today. GPT-5 releases tomorrow and you want to try it. Your session handoffs work with any tool — they're just markdown files.
...
In [Part 1](https://dev.to/dorothyjb/how-we-built-a-documentation-system-that-makes-llms-productive-immediately-59hc), we described how Mother CLAUDE contains instructions that the AI follows automatically. Session handoffs are part of those instructions:
...
*This is Part 2 of the Designing AI Teammates series. [Part 1](https://dev.to/dorothyjb/how-we-built-a-documentation-system-that-makes-llms-productive-immediately-59hc) covered onboarding with Mother CLAUDE. Part 3 will cover giving your AI assistant responsibility for initiating quality checkpoints.*

---

*This article was written collaboratively with Claude, using the session handoff process it describes.*
