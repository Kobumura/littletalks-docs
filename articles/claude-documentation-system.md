...
**Part 1 of the Designing AI Teammates series.** This article covers onboarding. [Part 2: Session Handoffs](./session-handoffs.md) covers persistent memory across sessions. [Part 3: Instant Retrospectives](./instant-retrospectives.md) covers assigning the AI responsibility for initiating quality conversations.
